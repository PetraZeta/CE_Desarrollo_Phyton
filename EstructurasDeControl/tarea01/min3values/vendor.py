"""
This module provides some utilities to support a proper running of pypas
software.
...
def launch(func: typing.Callable):
    ...
    if func_params := inspect.signature(func).parameters.keys():
        try:
            ...
            rich.print('[red]You have to create [b]args.py[/b] with the main \
                        function arguments!')
        else:
            ...
            for param in func_params:
                if param not in user_args:
                    rich.print(f'[red]Parameter [b]{param}[/b] must be \
                               defined in [b]args.py[/b]')
